...
public class RotateCommand implements CommandInterface {
    ...
    public String getDescription() {
        return "Rotate your profile picture.";
    }


    @Override
    public List<OptionData> getOptions() {
        return List.of(new OptionData(OptionType.INTEGER, "rotate_amount", "Rotation amount (in degrees)", true));
    }
    ...
    public void execute(SlashCommandInteractionEvent e) {
        ...
        int angle = Objects.requireNonNull(e.getOption("rotate_amount")).getAsInt();
        Helpers.currentUser.setRA(angle);
